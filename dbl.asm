...
SIO2C0	EQU	10H	;ACIA 0 CONTROL OUTPUT PORT
SIO2S0	EQU	10H	;ACIA 0 STATUS INPUT PORT
SIO2T0	EQU	11H	;ACIA 0 TX DATA REGISTER
SIO2R0	EQU	11H	;ACIA 0 RX DATA REGISTER
SIO2C1	EQU	12H	;ACIA 1 CONTROL OUTPUT PORT
SIO2S1	EQU	12H	;ACIA 1 STATUS INPUT PORT
SIO2T1	EQU	13H	;ACIA 1 TX DATA REGISTER
SIO2R1	EQU	13H	;ACIA 1 RX DATA REGISTER
...
PIO4CA0	EQU	20H		;PORT 0 SECTION A CTRL/STATUS
PIO4DA0	EQU	21H		;PORT 0 SECTION A DATA
PIO4CB0	EQU	22H		;PORT 0 SECTION B CTRL/STATUS
PIO4DB0	EQU	23H		;PORT 0 SECTION B DATA
...
;THE DISK DATA BUFFER
	...
	LXI	SP,STACK-OFFSET	;SET UP STACK
...
RDSECT:	PUSH	PSW		;SAVE RETRY COUNTER
	...
	LXI	H,BUFFER-OFFSET	;HL POINTS TO DISK BUFFER
...
;---------------------------------------------------------------
	...
	LXI	D,BUFFER+3-OFFSET	;START OF DATA PAYLOAD
...
RDDONE:	POP	B		;RESTORE SECTOR NUMBER
	...
	LHLD	BUFFER+1-OFFSET	;GET FILE BYTE COUNT FROM HEADER
...
ERHANG:	OUT	SIOTXD		;WRITE ERROR CODE TO SIO
	OUT	SIO2T0		;WRITE ERROR CODE TO 2SIO
	OUT	PIOTXD		;WRITE ERROR CODE TO PIO
	OUT	PIO4DB0		;WRITE ERROR CODE TO 4PIO
